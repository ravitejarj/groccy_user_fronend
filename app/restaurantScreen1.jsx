...
const sampleProducts = [
  {
    ...
    price: 18,
    quantity: 'Okra! - 500g',
    image: require('../assets/mobile-images/Food List/Food-1.png'),
    category: 'Vegetables',
  },
  {
    id: 2,
    ...
    return (
      <TouchableOpacity style={styles.productCard} onPress={() => router.push({ pathname: '/product', params: { name: item.name, images: JSON.stringify(sliderImages) } })} activeOpacity={0.8}>
        ...
        <View style={styles.productInfo}>
          ...
          <Text style={styles.productWeight}>{item.quantity}</Text>
